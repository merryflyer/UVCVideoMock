...
//    		mNativePtr = 0;	// nativeDestroyを呼ぶのでここでクリアしちゃダメ
	...
	public void setPreviewSize(final int width, final int height, final int min_fps, final int max_fps, final int frameFormat, final float bandwidthFactor) {
		...
		StringBuilder localStringBuilder2 = localStringBuilder1.append("setPreviewSize mNativePtr = ");
		long l1 = mNativePtr;
		long l2 = 0L;
		boolean bool;
		if (l1 != l2)
			...
			bool = false;
		StringBuilder localStringBuilder3 = localStringBuilder2.append(bool);
