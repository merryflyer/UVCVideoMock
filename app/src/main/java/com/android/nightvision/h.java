...
class h implements Runnable {
    ...
    public void run() {
        int i = this.f90a;
        if (i == 1) {
            if (this.f91b.mUVCCameraHelper.isCameraOpened() && this.f91b.mUVCCameraHelper.isPreviewing() && !this.f91b.o()) {
                this.f91b.r();
                this.f91b.mUVCCameraHelper.capturePicture(this.f91b.r_UnKnow);
            }
