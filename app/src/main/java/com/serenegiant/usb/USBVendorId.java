...
public class USBVendorId {
    ...
    static {
        ...
        IDS.put(PointerIconCompat.TYPE_HELP, "Atmel Corporation");
        ...
        IDS.put(PointerIconCompat.TYPE_GRAB, "Elitegroup Computer Systems");
        ...
        IDS.put(UVCCameraHelper.VENDOR_ID, UVCCameraHelper.MANUFACTURER_NAME);
